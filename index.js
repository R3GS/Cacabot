...
const WANTED_LIEUX = [
    "le salon vocal 'général' de Regaïa un lundi soir",
    "un Carrefour Market à 23h52 un dimanche",
    "les toilettes d'un McDo lors d'une affluence maximale",
    ...
    "un salon de jeux de cartes à Séoul selon les témoins",
    "une foire aux cartes à collectionner dans un gymnase de banlieue",
    "les DM d'un serveur Discord de fans One Piece",
...
const WANTED_STATUTS = [
    ...
    "🟠 A fui au dernier moment connu vers la Corée",
