...
if (command === "!choix") {
    ...
    if (cleaned.includes("tasty") || cleaned.includes("crousty") || cleaned.includes("tasty crousty")) return "https://cdn.discordapp.com/attachments/1480756332373213275/1528444984930467961/ezgif-83397d855d997e32.gif";
    if (
        cleaned === "monster" ||
